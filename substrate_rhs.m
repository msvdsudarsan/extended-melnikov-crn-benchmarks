function dydt = substrate_rhs(~,y,p)
...
%%
%% Paper Model 1: Substrate Inhibition Oscillator
if nargin<3, p.epsilon=0.005; p.mu=0; end
hill=y(1)/(1+y(1)^2);
dydt=zeros(2,1);
dydt(1)=(1/p.epsilon)*(y(2)-hill);
dydt(2)=0.5-y(2)-hill+p.mu*y(1);
end
